...
public EducationalBook(double price, int number_of_pages, long Isbn, int IssueYear, String Title, String AuthorName,int editionNum, String specialty_field){
...
public boolean equals(Object publication){
	...
	else if(getClass() != publication.getClass()) //make sure the parameter is the same class as the compared object
	{
		...
		EducationalBook book = (EducationalBook) publication; //type cast parameter into EducationBook class
